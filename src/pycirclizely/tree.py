...
#                     self._node2label_props[node_name].utils.helper.deep_dict_update(
#                         color=kwargs["color"]
#                     )
#         else:
...
#                 _line_kws.utils.helper.deep_dict_update(
...
#                     _align_line_kws.utils.helper.deep_dict_update(
#                         dict(color=_line_kws["color"])
#                     )
